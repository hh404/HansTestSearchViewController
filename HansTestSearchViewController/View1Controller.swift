...
class View1Controller: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.title = "name Demo"
        self.navigationItem.title = "abc123"
    }
...
extension View1Controller: UISearchBarDelegate {
...
extension View1Controller: UISearchResultsUpdating {
